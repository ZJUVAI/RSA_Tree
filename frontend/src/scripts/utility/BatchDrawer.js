...
module.exports.default = BatchDrawer;

function BatchDrawer(canvas, params) {
...
BatchDrawer.prototype = {
    ...
    _initArrayBuffer: function (data, item_size) {
    ...
    _createShaderProgram: function (vertexSource, fragmentSource, shape) {
    ...
    _compileShader: function (shaderSource, shaderType) {
    ...
    _initUniforms: function () {
        ...
        -1, 1, 1]);
        let resScaleX = this.transform.k;
        let resScaleY = this.transform.k;
        ...
        let lineTranslate = this.GL.getUniformLocation(this.lineProgram, 'resolutionTranslate');
        this.GL.uniform2f(lineTranslate, this.transform.x, this.transform.y);
    ...
    setPixelOrigin: function (pixelOrigin) {
    ...
    addLine: function (startX, startY, endX, endY, width, colorR, colorG, colorB, colorA) {
    ...
    addDot: function (posX, posY, size, colorR, colorG, colorB, colorA) {
    ...
    draw: function (keepOld, transform) {
